        ...
        <div className="mt-8 pt-6 border-t border-white/5">
          <div className="font-mono text-xs text-slate-500 flex justify-between items-center group cursor-help relative">
            ...
            <div className="flex gap-3">
              <span title="Input Sanitization via Zod Active" className="flex items-center gap-1 hover:text-slate-300 transition-colors">
                🛡️ Input Check
              </span>
              <span title="Spam Protection Active" className="flex items-center gap-1 hover:text-slate-300 transition-colors">
                🚫 Zero-Spam
              </span>
            </div>
            ...
            <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-64 p-3 bg-black/90 text-slate-300 text-[10px] rounded border border-white/10 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10">
              ...
              <ul className="list-disc ml-4 mt-1 space-y-1">
                <li>Zod Validation (Data Integrity)</li>
                <li>Rate Limiting (No SignUp Spam)</li>
              </ul>
            </div>
          </div>
        </div>
